...
function generateAccessToken(userId) {
  ...
  const auth0Client = new auth0.AuthenticationClient({
    domain: 'dev-fpyi1jg2tf72nn88.us.auth0.com', // Reemplaza con tu dominio de Auth0
    clientId: 'AIDXCYPzNY7cstjlyVUCBTVJ22fUWFD4', // Reemplaza con tu ID de cliente de Auth0
    AUTH0_CLIENT_SECRET: 'w4d-4WkE1NbmyBDTzLRHYzOysq_rYqT6iwfKVH94aXso3MxXoPpl6IKbBa-bNz_X',
